...
- (UIView *)viewForMessage:(NSString *)message title:(NSString *)title image:(UIImage *)image {
    ...
    if(messageLabel != nil) {
        ...
        messageTop = titleTop + titleHeight + imageHeight + CSToastVerticalPadding * 2;
    } else {
    ...
    CGFloat wrapperHeight = MAX((messageTop + messageHeight + CSToastVerticalPadding * 2), (imageHeight + (CSToastVerticalPadding * 2)));
                         
    wrapperView.frame = CGRectMake(0.0, 0.0, wrapperWidth, wrapperHeight);
    
    if(titleLabel != nil) {
        titleLabel.frame = CGRectMake((wrapperWidth-titleWidth)/2, titleTop, titleWidth, titleHeight);
    ...
    if(imageView != nil) {
        imageView.frame = CGRectMake((wrapperWidth-imageWidth)/2, (wrapperHeight-imageHeight)/2-CSToastVerticalPadding*2, imageWidth, imageHeight);
